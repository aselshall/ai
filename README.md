...
## Teaching Assistant
TBA Office Hours: By appointment
...
2. **Redefined roles** where the instructor acts as a mentor for higher-order reasoning, AI serves as a tutor for routine tasks, and the student becomes a lifelong learner, fostering a collaborative human-AI learning environment.
3. **Scaffolded AI use** with a mix of no-AI use, AI-resistant assignments, structured-AI use, and open-AI use on complex projects, building foundational knolwedge that is required effectively and efficiently leverage AI assistance.
