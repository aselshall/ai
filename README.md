...
3. **Scaffolded AI use** with a mix of no-AI use, AI-resistant assignments, structured-AI use, and open-AI use on complex projects, to build foundational knolwedge that is required effectively and efficiently leverage AI assistance.
